...
class Game:
    ...
    def create_boss_sprite(self, path, size=80):
        surf = pygame.Surface((size, size), pygame.SRCALPHA)
        pygame.draw.rect(surf, self.game.coral, (0, 0, size, size), border_radius=10)
        pygame.draw.rect(surf, self.game.ocean_accent, (10, 10, size - 20, size - 20), 5, border_radius=5)
        pygame.image.save(surf, path)
